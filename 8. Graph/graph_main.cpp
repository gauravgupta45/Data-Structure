...
int main()
{
    ...
    do
    {
        cout<<endl<<"1. Add Vertex"<<endl<<"2. Add Adjecent"<<endl<<"3. Show Vertices"<<endl<<"4. Show Adjecents"<<endl<<"5. Delete"<<endl<<"6. Exit"<<endl<<endl;
        cin>>ch;
        switch(ch)
        {
        case 1:
        ...
        case 4:
            ...
            break;
        case 5:
            cout<<endl<<"Under Construction!"<<endl;
            break;
        }
    }while(ch!=6);
    return 0;
